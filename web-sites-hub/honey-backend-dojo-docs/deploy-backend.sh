...
# 配置变量
DEPLOY_DIR="/var/www/html/honey-backend-dojo"
...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "示例:"
    echo "  sudo ./deploy-backend.sh backend-docs-nginx-20241105_195319.tar.gz"
    exit 1
fi
...
echo "📋 部署信息:"
echo "   - 部署目录: $DEPLOY_DIR"
echo "   - 访问地址: https://blog.joketop.com/backend"
echo ""
